...
function AgeCheck(){
    ...
    if (age < 16)
    {
        document.querySelector('p').innerHTML = "You can not drive"
    }
    else if (age < 18)
    {
        document.querySelector('p').innerHTML = "You can't hate from outside the club, because you can't even get in"
    }
    else if (age < 21)
    {
